...
from .config import WorkflowConfig, GraphConfig
from ..exceptions import WorkflowConfigError, WorkflowValidationError
...
class WorkflowConfigManager(IWorkflowConfigManager):
    ...
    def load_config(self, config_path: str) -> str:
        ...
        try:
            ...
            raise WorkflowConfigError(f"配置加载失败: {str(e)}")
