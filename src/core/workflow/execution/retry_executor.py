...
class RetryExecutor(IRetryExecutor):
    ...
    def __init__(self, config: Optional[RetryConfig] = None):
        ...
        logger.debug(f"重试执行器初始化完成，策略: {self.config.strategy.value}")
        ...
        **kwargs: Any
        ...
        for attempt in range(self.config.max_retries + 1):
            ...
            try:
                ...
                result = workflow.run(initial_data, **kwargs)
        ...
        **kwargs: Any
        ...
        for attempt in range(self.config.max_retries + 1):
            ...
            try:
                ...
                result = await workflow.run_async(initial_data, **kwargs)
...
def execute_with_retry(
    ...
    **kwargs: Any
    ...
    return executor.execute(workflow, initial_data, **kwargs)
...
async def execute_with_retry_async(
    ...
    **kwargs: Any
    ...
    """
    executor = RetryExecutor(config)
    return await executor.execute_async(workflow, initial_data, **kwargs)