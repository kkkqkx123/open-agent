...
def create_retry_config_from_legacy(
    ...
    return RetryConfig(
        ...
        retry_on_status_codes=retry_on_status_codes or [429, 500, 502, 503, 504],
        retry_on_errors=retry_on_errors or ["timeout", "rate_limit", "service_unavailable"],
    )


def create_timeout_config_from_legacy(
    timeout: int = 30,
    ...
    return TimeoutConfig(
        ...
        connect_timeout=connect_timeout or min(10, timeout),
        read_timeout=read_timeout or timeout,
        write_timeout=write_timeout or timeout,
    )