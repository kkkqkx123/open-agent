...
class AbstractThreadData(ABC):
    ...
    定义线程数据的基本契约，所有线程相关数据结构应实现此接口。
    这是领域层的核心实体，封装线程的业务概念。
    """
