...
class IConfigMerger(ABC):
    ...
    @abstractmethod
    def resolve_inheritance(self, config: Dict[str, Any], config_type: str, group_configs: Optional[Dict[str, Dict[str, Any]]] = None) -> Dict[str, Any]:
        """解析配置继承
...
class ConfigMerger(IConfigMerger):
    ...
    def merge_configs_by_priority(self, configs: List[Dict[str, Any]], priority_keys: Optional[List[str]] = None) -> Dict[str, Any]:
        """按优先级合并配置
    ...
    def extract_differences(self, config1: Dict[str, Any], config2: Dict[str, Any]) -> Dict[str, Any]:
        """提取两个配置的差异
