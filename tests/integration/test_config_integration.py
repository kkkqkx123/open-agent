...
from src.config.config_validator_tool import ConfigValidatorTool
...
class TestConfigIntegration:
    ...
    def test_complete_config_loading_workflow(self):
        ...
        try:
            ...
            assert gemini_config.base_url == "https://generativelanguage.googleapis.com/v1"
            ...
            assert code_agent_config.system_prompt == "You are a code analysis assistant."
            ...
            # 加载工具配置
            advanced_tools_config = self.config_system.load_tool_config("advanced_tools")
