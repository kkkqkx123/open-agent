...
class TestAnthropicClient:
    ...
    def test_generate_with_system_message(self, client):
        ...
        # 执行测试
        messages = [SystemMessage(content="系统指令"), HumanMessage(content="测试输入")]
        response = client.generate(messages)
    ...
    def test_generate_model_not_found_error(self, client):
        ...
        assert exc_info.value.model_name == "claude-3-sonnet-20240229"
