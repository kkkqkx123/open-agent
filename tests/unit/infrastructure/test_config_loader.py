...
class TestYamlConfigLoader:
    ...
    def test_resolve_nested_env_vars(self) -> None:
        ...
        try:
            ...
            assert resolved["server"]["endpoints"][1]["url"] == "http://localhost:8000/health"
    ...
    def test_validate_config_structure(self) -> None:
        ...
        result = loader.validate_config_structure(valid_config, ["log_level", "log_outputs"])
        ...
        result = loader.validate_config_structure(invalid_config, ["log_level", "log_outputs"])
