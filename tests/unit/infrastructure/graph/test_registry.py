...
class TestBaseNode:
    ...
    def test_node_type_property(self):
        ...
        assert BaseNode.node_type.__isabstractmethod__

    def test_execute_method(self):
        """测试执行方法"""
        # 检查方法是否为抽象的
        assert hasattr(BaseNode, 'execute')
        assert BaseNode.execute.__isabstractmethod__

    def test_get_config_schema_method(self):
        """测试获取配置模式方法"""
        # 检查方法是否为抽象的
        assert hasattr(BaseNode, 'get_config_schema')
        assert BaseNode.get_config_schema.__isabstractmethod__
...
class TestNodeRegistry:
    ...
    def test_register_node_success(self, registry):
        """测试成功注册节点类型"""
        # 创建模拟节点类
        class MockNode(BaseNode):
            @property
    ...
    def test_register_node_none(self, registry):
        """测试注册None节点"""
        with pytest.raises(ValueError, match="节点类不能为None"):
            registry.register_node(None)

    def test_register_node_missing_node_type(self, registry):
        ...
        with pytest.raises(ValueError, match="节点类缺少 node_type 属性"):
            registry.register_node(InvalidNode)

    def test_register_node_duplicate(self, registry):
        """测试注册重复节点类型"""
        # 创建模拟节点类
    ...
    def test_register_node_instance_success(self, registry):
        """测试成功注册节点实例"""
        # 创建模拟节点实例
        class MockNode(BaseNode):
            @property
    ...
    def test_register_node_instance_none(self, registry):
        """测试注册None节点实例"""
        with pytest.raises(ValueError, match="节点实例不能为None"):
            registry.register_node_instance(None)

    def test_register_node_instance_missing_node_type(self, registry):
        ...
        node_instance = InvalidNode()
        
        with pytest.raises(ValueError, match="节点实例缺少 node_type 属性"):
            registry.register_node_instance(node_instance)

    def test_register_node_instance_duplicate(self, registry):
        """测试注册重复节点实例"""
        # 创建模拟节点实例
        class MockNode(BaseNode):
            @property
    ...
    def test_get_node_class_success(self, registry):
        """测试成功获取节点类型"""
        # 创建模拟节点类
        class MockNode(BaseNode):
            @property
    ...
    def test_get_node_instance_registered_instance(self, registry):
        """测试获取已注册的节点实例"""
        # 创建模拟节点实例
        class MockNode(BaseNode):
            @property
    ...
    def test_get_node_instance_new_instance(self, registry):
        """测试获取新创建的节点实例"""
        # 创建模拟节点类
        class MockNode(BaseNode):
            @property
    ...
    def test_get_node_instance_not_found(self, registry):
        """测试获取不存在的节点实例"""
        with pytest.raises(ValueError, match="未知的节点类型: nonexistent_node"):
    ...
    def test_get_node_schema_success(self, registry):
        """测试成功获取节点配置模式"""
        # 创建模拟节点类
        class MockNode(BaseNode):
            @property
    ...
    def test_get_node_schema_not_found(self, registry):
        """测试获取不存在节点的配置模式"""
        with pytest.raises(ValueError):
            registry.get_node_schema("nonexistent_node")

    def test_validate_node_config_success(self, registry):
        """测试成功验证节点配置"""
        # 创建模拟节点类
        class MockNode(BaseNode):
            @property
    ...
    def test_validate_node_config_not_found(self, registry):
        """测试验证不存在节点的配置"""
...
class TestGlobalRegistryFunctions:
    ...
    def test_register_node_global(self):
        """测试全局注册节点"""
        # 重置全局注册表
        import src.infrastructure.graph.registry
        src.infrastructure.graph.registry._global_registry = None
    ...
    def test_register_node_instance_global(self):
        """测试全局注册节点实例"""
        # 重置全局注册表
        import src.infrastructure.graph.registry
        src.infrastructure.graph.registry._global_registry = None
...
class TestNodeDecorator:
    ...
    def test_node_decorator(self):
        ...
        assert OriginalNode().node_type == "decorated_node"
