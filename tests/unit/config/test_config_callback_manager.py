...
class TestConfigCallbackManager:
    ...
    def test_trigger_callbacks(self):
        ...
        # 注册回调
        manager.register_callback("callback1", callback1, priority=CallbackPriority.HIGH)
    ...
    def test_execution_order_by_priority(self):
        ...
        manager.register_callback("callback2", callback2, priority=CallbackPriority.HIGHEST)
        manager.register_callback("callback3", callback3, priority=CallbackPriority.NORMAL)
    ...
    def test_list_callbacks(self):
        ...
        manager.register_callback("callback2", test_callback2, priority=CallbackPriority.HIGH)
