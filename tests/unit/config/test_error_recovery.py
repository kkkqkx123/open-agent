...
class TestConfigValidatorWithRecovery:
    ...
    def test_validate_with_recovery_success(
        self, validator_with_recovery, test_config_file
    ):
        """测试验证成功"""
    ...
    def test_validate_with_recovery_failure_and_recovery(
        self, validator_with_recovery, test_config_file
    ):
        """测试验证失败并恢复"""
        # 创建备份
    ...
    def test_validate_with_recovery_failure_no_recovery(
        self, validator_with_recovery, temp_dir
    ):
        """测试验证失败且无法恢复"""
        # 创建无效配置文件
